...
namespace IX.Retry
{
    public static partial class Policy
    {
        ...
        public static IRetryPolicy CountBased(int maximumRetries, IEnumerable<Type> retryForExceptionTypes)
        {
        ...
        /// <param name="retryForExceptionTypes">Retry for certain exception types.</param>
        /// <returns>A time-based retry policy instance.</returns>
        public static IRetryPolicy CountBased(int maximumRetries, BackOffPolicy backOffPolicy, IEnumerable<Type> retryForExceptionTypes)
        {
            return new CountBasedRetryPolicy(maximumRetries, backOffPolicy, retryForExceptionTypes);
        }
